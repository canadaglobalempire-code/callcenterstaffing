...
export const site = {
  ...
  shortName: 'CCS',
  description:
    'A call center staffing agency with trained agents ready to deploy to your business. Temporary or long-term, onshore or offshore. Pay only for hours worked.',
  url: siteUrl.replace(/\/$/, ''),
