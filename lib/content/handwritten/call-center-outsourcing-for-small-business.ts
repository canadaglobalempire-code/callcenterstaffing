...
export const post: Post = {
  ...
  metaTitle: 'Call Center Outsourcing for Small Business 2026',
  metaDescription:
    'Call center outsourcing for small business: shared vs dedicated agents, the smallest scope worth buying, what to document first, and when to wait.',
  ...
  sections: [
    {
      paragraphs: [
        'A small business that goes looking for call center outsourcing is rarely looking for a call center. It is looking for a way to stop missing calls during the lunch rush, to get appointments booked while the owner is on a job site, or to give customers an answer on Saturday without the founder carrying the phone. That is a much smaller purchase than the one most outsourcing proposals are built to sell.',
    ...
    {
      heading: 'Shared and dedicated agents are two different products',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Buy one lane, not a department',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'What the founder has to write down first',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'When one or two placed agents beat an outsourced program',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Contract terms that are bigger than the problem',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'A first month that tells you something',
      level: 2,
      paragraphs: [
  ...
  faqs: [
    {
      q: 'What is the difference between shared and dedicated agents for a small business?',
      a: 'Shared agents sit in a pool that answers for many companies and work from your script and notes, so you pay for usage rather than for a person. Dedicated agents work only on your business, learn your products and customers, and usually operate inside your own systems. Shared suits message taking, booking and after-hours coverage. Dedicated suits work that needs judgment, product depth or continuity with repeat callers.',
    },
    {
      q: 'What is the smallest call center scope a small business can outsource?',
      a: 'A single bounded lane with a clear finish line, such as new inquiry capture, appointment scheduling, order status, or after-hours answering with a written urgency rule. You should be able to state in one sentence which calls belong in the lane. Starting with one lane keeps the commitment proportionate and shows how well your written instructions hold up before you hand over anything that depends on judgment.',
    },
    {
      q: 'What should a founder document before outsourcing calls?',
      a: 'Write down the main call reasons in customer language, the approved answer to each, your greeting and tone, an escalation map with names and hours, the limits of what an agent may decide alone, the refund and complaint rule, the systems and permission levels required, and a precise definition of urgent. Test the document by having someone outside the business role-play several calls and noting where they stall.',
    },
    {
      q: 'When is hiring one or two agents better than outsourcing for a small company?',
      a: 'When callers expect to reach the same person, when the work happens inside your own software rather than through messages, when volume is steady enough to fill most of a shift, and when the phone is where sales are won. You take on absence cover, coaching and quality review in return. Two people give thin backup for time off. One person gives none, so keep a fallback for gaps.',
    },
    {
      q: 'How do I know it is too early to outsource my business calls?',
      a: 'It is too early if your offer or service area still changes weekly, if you could not score a call as good or bad against written criteria, if you need every call handled exactly your way, if volume is too thin for an outside agent to build repetition, or if nobody has an hour a week to own the relationship. Simple tools such as online booking and a staff call rota can bridge the gap.',
    },
    {
      q: 'What contract terms should a small business check with an answering or call center provider?',
      a: 'Check for minimum commitments on seats, hours or usage and what you owe when volume falls below them. Confirm the billing unit matches the shape of your volume, how much notice ends the agreement, whether scope can shrink without cancelling, how script changes are made, that your phone number and call records remain yours, and whether growing into dedicated agents needs a new contract or an amendment.',
    },
  ],
};
