...
export const post: Post = {
  ...
  metaTitle: 'Nearshore Call Center Outsourcing 2026',
  metaDescription:
    'Nearshore call center outsourcing for US teams: time-zone overlap, bilingual program design, management proximity, and what nearshore will not fix.',
  ...
  sections: [
    ...
    {
      heading: 'What counts as nearshore from a US seat',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Time-zone overlap: what it buys during a working week',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Bilingual programs: design the program before you hire for it',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Management proximity: use it or lose it',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'What nearshore does not solve',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Ramp capacity and the supervisor bench',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Choosing a country and a city',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Requests that expose weak proposals',
      level: 2,
      bullets: [
    ...
    {
      heading: 'Nearshore outsourcing or nearshore staffing',
      level: 2,
      paragraphs: [
  ...
  faqs: [
    {
      q: 'What is nearshore call center outsourcing?',
