...
export const post: Post = {
  ...
  metaTitle: 'Ecommerce Customer Service Outsourcing 2026',
  metaDescription:
    'How to outsource ecommerce customer service: order-status and returns volume, peak ramp, helpdesk access, chat and email first, refund and fraud limits.',
  ...
  sections: [
    ...
    {
      heading: 'Tag a month of tickets before you talk to a vendor',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Order status and returns set your headcount',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Chat and email first, phone on purpose',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'The storefront, helpdesk and marketplace accounts stay yours',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Refund authority and fraud: write the limits down',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Peak season: work backward from the date',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Outsourced program, or more agents in your own helpdesk',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'What to check in the first ninety days',
      level: 2,
      paragraphs: [
