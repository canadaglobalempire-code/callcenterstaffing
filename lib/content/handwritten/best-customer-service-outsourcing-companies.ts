...
export const post: Post = {
  ...
  metaTitle: 'Best Customer Service Outsourcing Companies 2026',
  metaDescription:
    'Evaluate customer service outsourcing companies in 2026 by channel mix, written tone tests, knowledge base upkeep, helpdesk access and CSAT ownership.',
  ...
  sections: [
    ...
    {
      heading: 'What you have to hand over before anyone can do this well',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'How your channel mix changes the shortlist',
      level: 2,
      paragraphs: [
    ...
    {
      heading: "Provider types, seen from a support leader's seat",
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Hours, languages and where the team sits',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Grade real writing before you grade the pitch',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Knowledge base, macros and the feedback loop',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Design the escalation path in both directions',
      level: 2,
      paragraphs: [
    ...
    {
      heading: 'Warning signs during evaluation',
      level: 2,
      bullets: [
    ...
    {
      heading: 'If the process is strong and the team is short',
      level: 2,
      paragraphs: [
