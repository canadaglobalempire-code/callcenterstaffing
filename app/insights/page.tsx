...
export const metadata: Metadata = {
  ...
  description:
    'Pain-point playbooks for contact-center leaders: understaffed floors, broken recruiting funnels and slipping SLAs, with diagnostics and operational fixes.',
